...
const TablePaginationActions = (props: Props) => {
    ...
    const { count, page, rowsPerPage, onPageChange, pageNosArray } = props;
    ...
    return (
        <div className="tablePaginator">
            <div className="pageDropdown">
                ...
                <select disabled={pageNosArray?.length === 0} onChange={handlePageChange} className="pageSelector">
                    {PageDropdown}
                </select>
            </div>
            ...
            <Box sx={{ flexShrink: 0, ml: 1.5, position: 'absolute', top: '10%', right: '3%' }}>
                ...
                <IconButton
                    ...
                    disabled={page >= Math.ceil(count / rowsPerPage) - 1 || pageNosArray?.length === 0}
