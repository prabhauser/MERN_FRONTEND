...
import themes from '../../../utilities/theme/theme.module.scss';
// material
...
const UserListToolbar = (props: Props) => {
    ...
    return (
        ...
        >
            {text ? (
                <div className={displayInput ? 'typeAndCount' : 'countOnly'}>
            ...
            {displayInput && !downloadButton ? (
                <div>
                    ...
                    ) : !customButton && !filterButton && !approveButton ? null : (
                        <div className="filter" onClick={drawerOpen}>
                            <img src={filterIcon} />
                            <span>
                                Filter{' '}
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                            <div>
                                <img className="DownloadIcon" src={DownloadReport} alt="addIcon" />
                            </div>
